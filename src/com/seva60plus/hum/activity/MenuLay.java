...
public class MenuLay extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		option1 = (RelativeLayout) findViewById(R.id.ll_elderCare);
		...
		option2 = (RelativeLayout) findViewById(R.id.ll_medicalCare);
		...
		option4 = (RelativeLayout) findViewById(R.id.ll_funeralService);
