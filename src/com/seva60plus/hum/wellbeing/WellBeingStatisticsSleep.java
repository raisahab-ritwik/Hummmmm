...
public class WellBeingStatisticsSleep extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		backSetup.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if (Util.isInternetAvailable(WellBeingStatisticsSleep.this)) {
					...
					Intent i = new Intent(WellBeingStatisticsSleep.this,
		...
		tab_task.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intObj = new Intent(WellBeingStatisticsSleep.this,
						WellBeingActivitySleep.class);
				startActivity(intObj);
				overridePendingTransition(0, 0);
				finish();
	...
	private void shareAppLinkViaTwitter() {
		...
		try {
			...
			intent1.setClassName("com.twitter.android",
	...
	private void openChart() {
		...
		String[] code = new String[] { "Less Than 5", "Around 8",
				"More Than 8", "NA" };
	...
	public void onHomeClick(View v) {
		startActivity(new Intent(WellBeingStatisticsSleep.this,
