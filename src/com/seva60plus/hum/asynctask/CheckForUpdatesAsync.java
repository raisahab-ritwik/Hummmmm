...
public class CheckForUpdatesAsync extends AsyncTask<Void, Void, String> implements OnCancelListener {
	...
	private int CONNECTIONTIMEOUT = 8 * 1000;
	...
	protected String doInBackground(Void... arg0) {
		...
		HttpPost myConnection2 = new HttpPost("http://seva60plus.net/seva60PlusAndroidAPI/dbversion");
		...
		try {
			...
			e.printStackTrace();
			updateAppVersion = "Timeout";
			//Toast.makeText(mContext, "Slow internet.", Toast.LENGTH_LONG).show();
