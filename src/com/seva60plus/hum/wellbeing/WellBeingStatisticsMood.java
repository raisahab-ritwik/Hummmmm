...
public class WellBeingStatisticsMood extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		progress.getWindow().setBackgroundDrawableResource(
				R.drawable.spinner_dialog_backround);
		...
		ImageView progressSpinner = (ImageView) progress
				.findViewById(R.id.progressSpinner);

		// Set the background of the image - In this case an animation
		// (/res/anim folder)
		progressSpinner
				.setBackgroundResource(R.anim.spinner_progress_animation);
		...
		whatsapp.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SocialNetworking
						.shareAppLinkViaWhatsApp(WellBeingStatisticsMood.this);
			}
		});
		...
		fb.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SocialNetworking
						.shareAppLinkViaFacebook(WellBeingStatisticsMood.this);
			}
		});
		...
		twitter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SocialNetworking
						.shareAppLinkViaTwitter(WellBeingStatisticsMood.this);
			}
		});
		...
		backSetup.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if (Util.isInternetAvailable(WellBeingStatisticsMood.this)) {
					Intent i = new Intent(WellBeingStatisticsMood.this,
							HumDetailsView.class);
					startActivity(i);
					overridePendingTransition(R.anim.slide_in_right,
							R.anim.slide_leave_right);
				} else {
					Intent i = new Intent(WellBeingStatisticsMood.this,
							NoInternetPage.class);
					startActivity(i);
		...
		tab_task.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intObj = new Intent(WellBeingStatisticsMood.this,
						WellBeingActivityMood.class);
				startActivity(intObj);
				overridePendingTransition(0, 0);
				finish();
		...
		tab_water.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intObj = new Intent(WellBeingStatisticsMood.this,
						WellBeingStatisticsSleep.class);
				startActivity(intObj);
				overridePendingTransition(0, 0);
				finish();
		...
		tab_execise.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intObj = new Intent(WellBeingStatisticsMood.this,
						WellBeingStatisticsExercise.class);
				startActivity(intObj);
				overridePendingTransition(0, 0);
				finish();
		...
		for (Contact cn : contacts) {
			String log = cn.getDate() + "--" + cn.getTime() + "--"
					+ cn.getResult() + "--" + cn.getStaus() + "--"
					+ cn.getMode() + "\n";
			...
			public void run() {
				try {
					...
					if (curTime.equals("0:1:0")) {
						...
						db.addContact(new Contact(toDate, curTime, "NA", "2",
								"Ex"));
	...
	public void onHomeClick(View v) {
		startActivity(new Intent(WellBeingStatisticsMood.this,
