...
public class MediaCentreDashBoard extends Activity implements OnClickListener {
	...
	private LinearLayout rl_hum_training, rl_doctor_speaks, rl_financial_advisory, rl_fitness, rl_technology,
			rl_art_and_culture, rl_food;
	private LinearLayout rl_travel;
	...
	private void initView() {
		...
		rl_hum_training = (LinearLayout) findViewById(R.id.ll_elderCare);

		rl_doctor_speaks = (LinearLayout) findViewById(R.id.ll_medicalCare);

		rl_financial_advisory = (LinearLayout) findViewById(R.id.rl_financial_advisory);

		rl_fitness = (LinearLayout) findViewById(R.id.ll_funeralService);

		rl_technology = (LinearLayout) findViewById(R.id.rl_technology);

		rl_art_and_culture = (LinearLayout) findViewById(R.id.rl_art_and_culture);

		rl_food = (LinearLayout) findViewById(R.id.rl_food);

		rl_travel = (LinearLayout) findViewById(R.id.rl_travel);
