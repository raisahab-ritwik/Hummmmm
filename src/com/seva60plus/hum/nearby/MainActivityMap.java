...
public class MainActivityMap extends Activity implements OnCancelListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mProgressHUD = ProgressHUD.show(mContext, "Please wait...", true, false, this);
	...
	// -----------Get Saathi List
	private class GetLocationList extends AsyncTask<Void, Integer, String> implements OnCancelListener {
				...
				if (countNum == 0) {
					...
					for (int i = 0; i <= countNum; i++) {
						...
						for (String ss : arr) {
							...
							if (iPlace.equals("atm") && ss.contains("atm")) {
								...
								fData.image = R.drawable.nearby_atm_normal;
								...
								fData.Fname = jName;
								fData.FuID = jLocatiion;
								fData.image = R.drawable.nearby_bank_normal;
								fData.destLate = Double.toString(lat);
								fData.destLang = Double.toString(lon);
							 ...
							 */
								...
								fData.Fname = jName;
								fData.FuID = jLocatiion;
								fData.image = R.drawable.nearby_hospital_normal;
								fData.destLate = Double.toString(lat);
								fData.destLang = Double.toString(lon);
								...
								fData.Fname = jName;
								fData.FuID = jLocatiion;
								fData.image = R.drawable.nearby_police_normal;
								fData.destLate = Double.toString(lat);
								fData.destLang = Double.toString(lon);
							...
							// ss.equals("lodging")){
								...
								fData.Fname = jName;
								fData.FuID = jLocatiion;
								fData.image = R.drawable.nearby_restaurant_normal;
								fData.destLate = Double.toString(lat);
								fData.destLang = Double.toString(lon);
							 ...
							 */
								...
								fData.Fname = jName;
								fData.FuID = jLocatiion;
								fData.image = R.drawable.nearby_shopping_normal;
								fData.destLate = Double.toString(lat);
								fData.destLang = Double.toString(lon);
					...
					list.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
							...
							// String distance = getDistance(iMyLate, iMyLang,
							// mData.getDestLate(), mData.getDestLang());
