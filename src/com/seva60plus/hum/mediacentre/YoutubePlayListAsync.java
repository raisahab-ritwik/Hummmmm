...
public class YoutubePlayListAsync extends AsyncTask<Void, Void, ArrayList<Video>> implements OnCancelListener {
	...
	protected ArrayList<Video> doInBackground(Void... params) {
		...
		try {
			...
			HttpUriRequest request = new HttpGet("https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=" + playlistId
					+ "&maxResults=25&key=AIzaSyAKgCx_f4jAfwjgrIbV5ZCXqyuwpk-oK5o");
