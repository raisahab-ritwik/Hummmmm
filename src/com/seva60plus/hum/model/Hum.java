...
public class Hum implements Serializable {
	...
	private boolean isReceiveReminder;
	private int id;
	...
	public boolean isReceiveReminder() {
		return isReceiveReminder;
	}

	public void setReceiveReminder(boolean isReceiveReminder) {
		this.isReceiveReminder = isReceiveReminder;
	}
