...
public class SpeedTestService extends Service {
	...
	private static final int EXPECTED_SIZE_IN_BYTES = 1048576899;// 1MB 1024*1024
	...
	private final Runnable mWorker = new Runnable() {
		...
		public void run() {
			...
			try {
				...
				String downloadFileUrl = "http://seva60plus.net/seva60PlusAndroidAPI/register/checkUserRegistered/123";
				...
				do {
					...
					if (updateDelta >= UPDATE_THRESHOLD) {
						...
						bytesInThreshold = 0;
						Log.v("Log", "stream read: " + stream.read());
						Log.v("Log", "Current byte: " + currentByte);
					}
