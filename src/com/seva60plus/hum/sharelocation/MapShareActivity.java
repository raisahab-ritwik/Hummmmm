...
public class MapShareActivity extends FragmentActivity implements FetchSaathiListListener, OnCancelListener {
	GoogleMap mMap;
	Marker mMarker;
	LocationManager lm;
	double lat, lng;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mProgressHUD = ProgressHUD.show(MapShareActivity.this, "Please wait! Finding your location...", true, false, this);
