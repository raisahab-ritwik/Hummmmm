...
public class Utilities extends Activity {
	...
	//private LinearLayout heartrate;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSwitch = (LinearLayout) findViewById(R.id.tourch_btn);
		...
		/*heartrate = (LinearLayout) findViewById(R.id.heartbeat_btn);
		...
		btnSwitch.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (hasFlash) {
					...
					Toast.makeText(Utilities.this, "Sorry Flash is not available", Toast.LENGTH_SHORT).show();
				}

			}
		});

		weather = (LinearLayout) findViewById(R.id.weather_btn);
		...
		contact = (LinearLayout) findViewById(R.id.contact_btn);
	...
	private void toggleButtonImage() {
		if (isFlashOn) {
			iv_torch.setImageAlpha(R.drawable.utilities_torch_selected);
		} else {
			iv_torch.setImageAlpha(R.drawable.utilities_torch_normal);
		}
	}*/
