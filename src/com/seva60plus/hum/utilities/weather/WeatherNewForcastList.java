...
public class WeatherNewForcastList extends Activity implements SwipeRefreshLayout.OnRefreshListener {
	...
	private class GetWeatherData extends AsyncTask<Void, Integer, String> implements OnCancelListener {

		@Override
		protected void onPreExecute() {
			// setting progress bar to zero
			mProgressHUD = ProgressHUD.show(WeatherNewForcastList.this, "Please wait...", true, false, this);
			super.onPreExecute();
		}
